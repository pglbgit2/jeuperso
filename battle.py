    ...
    def actualizeHP(self):
        if interaction.MOD == interaction.TERMINAL:
            for name in self.fightersNames.keys():
                ...
                print(someFighter.name+" HP:"+str(someFighter.HP)+" Stamina:"+str(someFighter.stamina)+" Magic:"+str(someFighter.magic)+" left hand: "+ ("Nothing" if someFighter.leftTool == None else str(someFighter.leftTool.name))+" right hand:"+ ("Nothing" if someFighter.rightTool == None else str(someFighter.rightTool.name)))
