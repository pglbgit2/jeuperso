...
MELEE_WEAPONS = ["KNIFE", "SPEAR", "SWORD", "SPIKED_CLUB", "LONG_SWORD", "MACE", "CORRUPTED_STAFF", "ENERGY_BLADE"]
...
ONE_HAND_WEAPONS = ["SWORD", "KNIFE", "SLINGSHOT", "SPIKED_CLUB"]
