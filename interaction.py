        ...
        while finished == False:
            try:
                ...
                while not allActionsInserted:
                    ...
                    if "Attack" in actionName or "Shot" in actionName or "Melee_Combat" == actionName or actionName == "Protection_Field" or actionName == "Minor_Shield" or "EnergyRay" == actionName or "EnergyOrb" == actionName or "FireBreath" == actionName:
                        ...
                        if actionName != "Melee_Combat" and actionName != "Protection_Field" and actionName != "Minor_Shield" and "EnergyRay" != actionName and "EnergyOrb" != actionName and "FireBreath" != actionName:         
